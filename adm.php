  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse top-right-menu-ul bounceInRight wow" id="bs-example-navbar-collapse-1" data-wow-duration="4s">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="index1.php">Features</a></li>
        <li><a href="index1.php">Products</a></li>
        <li><a href="order.php">Orders</a></li>
        <li><a href="index1.php">About</a></li>
        <li><a href="index1.php">Prices</a></li>
        <li><a href="index1.php">Testimonial</a></li>
...
<div class="container-fluid">
      ...
      <table class="table table-bordered table-dark table-hover table-bordered my-5 ">
       ...
       $co= $_SESSION['em'];
         $asd="select employee_id from employee where email='$co'";
